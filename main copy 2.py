...
def load_yolo_model(model_path):
    # Keep stdout clean because this command returns JSON.
...
def parse_args():
    ...
    parser.add_argument(
        "--output",
        default=None,
        help="Optional path to an Excel file to create.",
    )
    parser.add_argument(
        "--crops-dir",
        default=None,
    ...
    parser.add_argument(
        "--debug-image",
        default=None,
        help="Optional path or directory to save image(s) with YOLO detection boxes.",
    )
    parser.add_argument(
        "--model",
        # default="my_model/my_model.pt",
        default="runs/detect/khb_field_model_6fields/weights/best.pt",
